...
### 步骤 2：把 BrandBenchmark 时间提前到 07:00（PR #66）
...
### 步骤 3：新增 `daily-pipeline` 虚拟 Agent（PR #67）
...
### 步骤 4：AI 日报接入 BrandBenchmark（PR #67）
...
1. 用户确认本方案后，按 PR #66（时间调整）、PR #67（pipeline + 数据融合）分批实施。

...
export const I18N_DICT: Record<string, I18nEntry> = {
  ...
  "对明知或应知而未披露的重大瑕疵，卖方仍依法承担责任。平台仅提供信息展示与增值服务，询价撮合不收取交易服务费、不碰支付；拍卖等增值服务收费标准以该服务页面公示为准。": {
    "en": "Seller remains liable for known but undisclosed defects. Platform provides information display and value-added services only — no transaction fee for inquiry matching, no payment handling. For value-added services such as auctions, the applicable fees are published on the respective service page. ",
    "ru": "За умышленное или непреднамеренное сокрытие существенных дефектов продавец несет ответственность по закону. Платформа предоставляет только информационные услуги: за подбор по запросам цены комиссия не взимается, в платежах не участвует. Для дополнительных услуг, таких как аукционы, применяемые тарифы публикуются на соответствующей странице услуги. ",
    "es": "Por defectos graves no revelados, el vendedor asume la responsabilidad según la ley. La plataforma solo proporciona exhibición de información y servicios de valor agregado, sin cobrar tarifas por la intermediación de consultas ni gestionar pagos. Para servicios de valor agregado como subastas, las tarifas aplicables se publican en la página de ese servicio. ",
    "pt": "Por defeitos graves conhecidos ou que deveriam ser conhecidos e não divulgados, o vendedor ainda é responsável por lei. A plataforma fornece apenas exibição de informações e serviços de valor agregado, não cobra taxas pela intermediação de consultas e não lida com pagamentos. Para serviços de valor agregado, como leilões, as taxas aplicáveis são publicadas na página do respectivo serviço. ",
    "ar": "对于 العيوب الرئيسية التي لم يتم الكشف عنها، يتحمل البائع المسؤولية وفقًا للقانون. المنصة توفر فقط عرض المعلومات والخدمات القيمة المضافة، ولا تتقاضى رسومًا على مطابقة الاستفسارات، ولا تتعامل مع الدفع. بالنسبة للخدمات ذات القيمة المضافة مثل المزادات، تُنشر الرسوم المطبقة على صفحة الخدمة المعنية. ",
    "fr": "Pour les défauts majeurs que le vendeur connaît ou devrait connaître et qui n'ont pas été divulgués, le vendeur est toujours responsable conformément à la loi. La plateforme ne perçoit pas de frais pour la mise en relation des demandes et ne gère pas les paiements. Pour les services à valeur ajoutée tels que les enchères, les tarifs applicables sont publiés sur la page du service concerné. ",
    "hi": "जानबूझकर या जानने के बावजूद महत्वपूर्ण दोषों का खुलासा नहीं करने के लिए, विक्रेता कानूनी रूप से जिम्मेदारी लेता है। प्लेटफ़ॉर्म केवल जानकारी प्रदर्शन और मूल्य वर्धित सेवाएं प्रदान करता है, पूछताछ मिलान के लिए शुल्क नहीं लेता है, भुगतान से संपर्क नहीं करता है। नीलामी जैसी मूल्य वर्धित सेवाओं के लिए, लागू शुल्क संबंधित सेवा पृष्ठ पर प्रकाशित होते हैं। ",
  },
  "收到的报价": {
    "en": "Received Offers",
  ...
  "本功能为信息发布与价格协商撮合服务，不收取交易服务费、佣金或成交手续费。会员费、AI估值费等属于增值信息服务费，与设备交易无关。拍卖等增值服务如需使用，其收费标准以该服务页面公示为准。买卖双方按合同约定自行完成交易及资金收付。": {
    "en": "This feature is an information and price-inquiry matching service. It charges no transaction service fees, commissions, or closing fees. Membership and AI valuation fees are value-added information service fees, For value-added services such as auctions, the applicable fees are published on the respective service page. Buyers and sellers complete transactions and payments per their contract.",
    "ru": "Эта функция является услугой по публикации информации и согласованию цены, платформа не взимает комиссию за сделку, не берет процент или плату за услуги. Плата за членство, плата за оценку с помощью ИИ и т. д. являются платой за дополнительные информационные услуги и не связаны с сделкой по оборудованию. Для дополнительных услуг, таких как аукционы, применяемые тарифы публикуются на соответствующей странице услуги. Покупатель и продавец самостоятельно выполняют условия контракта и осуществляют платежи",
    "es": "Esta función es un servicio de publicación de información y negociación de precios. La plataforma no cobra tarifa de servicio de transacción, comisión o tarifa de transacción. La tarifa de membresía, la tarifa de estimación de AI, etc. son tarifas de servicios de información de valor agregado, y no están relacionadas con la transacción de equipos. Para servicios de valor agregado como subastas, las tarifas aplicables se publican en la página de ese servicio. Las partes compradora y vendedora completan la transacción y el pago según lo acordado en el contrato",
    "pt": "Este serviço é uma plataforma de publicação de informações e negociação de preços, e a plataforma não cobra taxas de transação, comissões ou taxas de serviço. As taxas de membros, taxas de avaliação de IA, etc. são taxas de serviços de informações adicionais e não estão relacionadas à transação de equipamentos. Para serviços de valor agregado, como leilões, as taxas aplicáveis são publicadas na página do respectivo serviço. As partes compradora e vendedora completam a transação e o pagamento de acordo com o contrato",
    "ar": "هذه الوظيفة هي خدمة نشر المعلومات وخدمة التفاوض على السعر ، ولا تتقاضى المنصة أي رسوم خدمة تجارية ، أو عمولة ، أو رسوم إبرام عقد. رسوم العضوية ، ورسوم التقييم الإلكتروني ، هي رسوم خدمات معلومات قيمة ، ولا علاقة لها بتعاملات المعدات. بالنسبة للخدمات ذات القيمة المضافة مثل المزادات، تُنشر الرسوم المطبقة على صفحة الخدمة المعنية. يتم إبرام الطرفين المتعاقدين العقد وتنفيذ الدفع بشكل مستقل",
    "fr": "Cette fonctionnalité est un service de publication d'informations et de négociation de prix, et la plateforme ne collecte aucun frais de transaction, de commission ou de frais de traitement. Les frais de membre, les frais d'évaluation par intelligence artificielle, etc. sont des frais de services d'information de valeur ajoutée, et n'ont aucun rapport avec la transaction d'équipement. Pour les services à valeur ajoutée tels que les enchères, les tarifs applicables sont publiés sur la page du service concerné. Les deux parties doivent conclure la transaction et le paiement selon les conditions convenues dans le contrat",
    "hi": "प्लेटफ़ॉर्म लेनदेन सेवा शुल्क, कमीशन या हस्तांतरण शुल्क नहीं लेता है। सदस्यता शुल्क, एआई मूल्यांकन शुल्क आदि मूल्य वर्धित सेवा शुल्क हैं, जो उपकरण लेनदेन से संबंधित नहीं हैं। नीलामी जैसी मूल्य वर्धित सेवाओं के लिए, लागू शुल्क संबंधित सेवा पृष्ठ पर प्रकाशित होते हैं। खरीदार और विक्रेता अनुबंध के अनुसार स्वयं लेनदेन और भुगतान करते हैं",
  },
  "询价规则与合规公示": {
  ...
  "询价撮合不收取交易服务费": {
    "en": "No transaction fee for inquiry matching",
    "ru": "За подбор по запросам цены комиссия не взимается",
    "es": "Sin tarifa de servicio de transacción por la intermediación de consultas",
    "pt": "Sem taxa de serviço de transação para intermediação de consultas",
    "ar": "لا رسوم خدمة على مطابقة الاستفسارات",
    "fr": "Aucun frais de service de transaction pour la mise en relation des demandes",
    "hi": "पूछताछ मिलान के लिए कोई लेनदेन सेवा शुल्क नहीं",
  },
  "本平台定位为农机设备信息发布与交流平台，提供信息展示、AI估值参考等增值服务。平台不参与设备交易撮合、不代收代付任何交易资金、不就询价撮合收取成交服务费或佣金；拍卖等增值服务如需使用，其收费标准以该服务页面公示为准。买卖双方自行完成交易，资金直接往来。": {
    "en": "This platform is an agricultural machinery information display and exchange platform offering information display, AI valuation references and other value-added services. We do not facilitate equipment transactions, hold transaction funds, or charge closing fees or commissions for inquiry matching. For value-added services such as auctions, the applicable fees are published on the respective service page. Buyers and sellers transact directly.",
    "ru": "Эта платформа позиционируется как платформа для публикации и обмена информацией о сельскохозяйственном оборудовании, предоставляющая услуги по демонстрации информации, справочную оценку на основе ИИ и другие услуги повышения ценности. Платформа не участвует в транзакциях, не принимает и не переводит какие-либо транзакционные средства, не взимает никаких комиссий или сборов, связанных с заключением сделок. Для дополнительных услуг, таких как аукционы, применяемые тарифы публикуются на соответствующей странице услуги. Покупатели и продавцы самостоятельно завершают транзакции, средства перечисляются напрямую.",
    "es": "Esta plataforma se posiciona como una plataforma de publicación y comunicación de información de equipos agrícolas, y proporciona servicios de valor agregado como exhibición de información, referencia de valoración AI, etc. La plataforma no participa en la intermediación de transacciones, no recibe ni paga fondos de transacción, y no cobra ninguna tarifa de servicio o comisión relacionada con la transacción. Para servicios de valor agregado como subastas, las tarifas aplicables se publican en la página de ese servicio. Las partes compradora y vendedora completan la transacción por sí mismas, y los fondos se transfieren directamente.",
    "pt": "Esta plataforma é posicionada como uma plataforma de publicação e intercâmbio de informações de equipamentos agrícolas, fornecendo serviços de valor agregado, como exibição de informações e referências de avaliação de IA. A plataforma não participa da negociação, não recebe ou paga fundos de transação e não cobra taxas de serviço ou comissões relacionadas à negociação. Para serviços de valor agregado, como leilões, as taxas aplicáveis são publicadas na página do respectivo serviço. As partes compradora e vendedora concluem a transação por conta própria, e os fundos são transferidos diretamente.",
    "ar": "تعتبر المنصة منصة لنشر المعلومات وتبادلها عن أجهزة الزراعة، وتوفر خدمات قيمة مضافة مثل عرض المعلومات وتقييم الذكاء الاصطناعي. لا تشارك المنصة في撮合 الصفقة، ولا تتلقى أو تدفع الأموال، ولا تتقاضى أي رسوم أو عمولات متعلقة بالصفقة. بالنسبة للخدمات ذات القيمة المضافة مثل المزادات، تُنشر الرسوم المطبقة على صفحة الخدمة المعنية. ي完成 الطرفان الصفقة بأنفسهم، والأموال تنتقل مباشرة بينهما.",
    "fr": "Cette plateforme est positionnée comme une plateforme de publication et d'échange d'informations sur les équipements agricoles, offrant des services de présentation d'informations, de référence d'estimation AI, etc. La plateforme ne participe pas à la mise en relation des transactions, ne perçoit ni ne verse des fonds de transaction, et ne perçoit pas de frais de service ou de commission liés à la transaction. Pour les services à valeur ajoutée tels que les enchères, les tarifs applicables sont publiés sur la page du service concerné. Les parties acheteuse et vendeuse concluent la transaction par elles-mêmes, et les fonds sont échangés directement.",
    "hi": "इस प्लेटफ़ॉर्म की स्थिति कृषि मशीनरी उपकरणों के लिए जानकारी प्रकाशन और आदान-प्रदान प्लेटफ़ॉर्म के रूप में है, जो जानकारी प्रदर्शन, एआई मूल्यांकन संदर्भ आदि मूल्य वर्धित सेवाएं प्रदान करता है। प्लेटफ़ॉर्म लेनदेन मध्यस्थता में भाग नहीं लेता है, किसी भी लेनदेन धन को नहीं लेता है, और किसी भी लेनदेन से संबंधित सेवा शुल्क या आयोग को नहीं लेता है। नीलामी जैसी मूल्य वर्धित सेवाओं के लिए, लागू शुल्क संबंधित सेवा पृष्ठ पर प्रकाशित होते हैं। खरीदार और विक्रेता स्वयं लेनदेन पूरा करते हैं, धन का सीधा आदान-प्रदान होता है।",
  },
  "会员服务": {
    "en": "Membership",
    "ru": "Услуги членства",
  ...
  "免费 / ¥88 / ¥158 / ¥288": {
    "en": "Free / ¥88 / ¥158 / ¥288",
    "ru": "Бесплатно / ¥88 / ¥158 / ¥288",
    "es": "Gratis / ¥88 / ¥158 / ¥288",
    "pt": "Gratuito / ¥88 / ¥158 / ¥288",
    "ar": "مجانية / ¥88 / ¥158 / ¥288",
    "fr": "Gratuit / 88 ¥ / 158 ¥ / 288 ¥",
    "hi": "नि:शुल्क / ¥88 / ¥158 / ¥288",
  },
  ...
  "询价撮合不收取与交易相关的服务费、佣金或手续费；拍卖等增值服务收费标准以该服务页面公示为准。交易完全由买卖双方自行协商完成。": {
    "en": "No transaction-related service fees, commissions or handling charges apply to inquiry matching. For value-added services such as auctions, the applicable fees are published on the respective service page. All transactions are conducted directly between buyers and sellers.",
    "ru": "За подбор по запросам цены не взимаются комиссии, сборы или платежи, связанные с транзакциями. Для дополнительных услуг, таких как аукционы, применяемые тарифы публикуются на соответствующей странице услуги.  Транзакции полностью осуществляются покупателями и продавцами путем прямых переговоров.",
    "es": "No se cobran tarifas de servicio, comisiones ni cargos relacionados con la transacción por la intermediación de consultas. Para servicios de valor agregado como subastas, las tarifas aplicables se publican en la página de ese servicio.  La transacción se completa completamente por las partes compradora y vendedora.",
    "pt": "Não são cobradas taxas de serviço, comissões ou tarifas relacionadas à transação para a intermediação de consultas. Para serviços de valor agregado, como leilões, as taxas aplicáveis são publicadas na página do respectivo serviço.  A transação é concluída por conta própria pelas partes compradora e vendedora.",
    "ar": "لا تُفرض أي رسوم أو عمولات أو مصاريف متعلقة بالصفقة على مطابقة الاستفسارات. بالنسبة للخدمات ذات القيمة المضافة مثل المزادات، تُنشر الرسوم المطبقة على صفحة الخدمة المعنية.  تتم الصفقة بالكامل بين الطرفين",
    "fr": "Aucuns frais de service, commission ou frais liés à la transaction ne sont perçus pour la mise en relation des demandes. Pour les services à valeur ajoutée tels que les enchères, les tarifs applicables sont publiés sur la page du service concerné.  La transaction est entièrement négociée et conclue par les parties acheteuse et vendeuse.",
    "hi": "पूछताछ मिलान के लिए लेनदेन से संबंधित कोई सेवा शुल्क, आयोग या शुल्क नहीं लिया जाता है। नीलामी जैसी मूल्य वर्धित सेवाओं के लिए, लागू शुल्क संबंधित सेवा पृष्ठ पर प्रकाशित होते हैं।  लेनदेन पूरी तरह से खरीदार और विक्रेता द्वारा स्वयं वार्ता के माध्यम से पूरा किया जाता है।",
  },
  "平台自身不代收代付交易资金、不设资金池，不自行提供资金托管或担保服务；相关服务（如有）由具备相应资质的机构依法独立提供。": {
    "en": "The platform itself does not collect or disburse transaction funds, maintain any fund pool, or provide fund custody or guarantee services on its own. Where such services exist, they are provided independently by duly licensed institutions in accordance with the law.",
    "ru": "Платформа сама не принимает и не переводит транзакционные средства, не формирует фонд средств и не предоставляет услуги по управлению или гарантии средств. Соответствующие услуги (при наличии) предоставляются независимо организациями, имеющими надлежащую лицензию, в соответствии с законом.",
    "es": "La plataforma, por sí misma, no recibe ni paga fondos de transacción, no mantiene fondo común alguno y no presta servicios de custodia o garantía de fondos. Dichos servicios (si existen) son prestados de forma independiente por instituciones debidamente autorizadas conforme a la ley.",
    "pt": "A plataforma, por si só, não recebe nem paga fundos de transação, não mantém pool de fundos e não fornece serviços de custódia ou garantia de fundos. Tais serviços (se houver) são prestados de forma independente por instituições devidamente licenciadas, nos termos da lei.",
    "ar": "لا تتلقى المنصة بنفسها أو تدفع أي أموال للصفقة، ولا تنشئ أي مجمع أموال، ولا تقدم بنفسها خدمات حفظ أو ضمان الأموال. أما الخدمات ذات الصلة (إن وُجدت) فتقدمها بشكل مستقل مؤسسات مرخصة وفقًا للقانون.",
    "fr": "La plateforme elle-même ne perçoit ni ne verse de fonds de transaction, ne détient aucun pool de fonds et ne fournit pas elle-même de services de garde ou de garantie de fonds. Le cas échéant, ces services sont fournis de manière indépendante par des institutions dûment agréées, conformément à la loi.",
    "hi": "प्लेटफ़ॉर्म स्वयं किसी भी लेनदेन धन को नहीं लेता या नहीं भेजता है, कोई धन पूल नहीं रखता है, और स्वयं धन ट्रस्टी या गारंटी सेवा प्रदान नहीं करता है। संबंधित सेवाएं (यदि उपलब्ध हों) विधि के अनुसार उचित लाइसेंस प्राप्त संस्थानों द्वारा स्वतंत्र रूप से प्रदान की जाती हैं।",
  },
  ...
  "付款后请将截图发送至 jiusei0319@gmail.com 或致电 +86 18633878701 确认": {
    "en": "After payment, send screenshot to jiusei0319@gmail.com or call +86 18633878701.",
    "ru": "После оплаты, пожалуйста, отправьте скриншот на jiusei0319@gmail.com или позвоните по номеру +86 18633878701 для подтверждения",
    "es": "Después del pago, envíe una captura de pantalla a jiusei0319@gmail.com o llame al +86 18633878701 para confirmar",
    "pt": "Após o pagamento, por favor envie uma captura de tela para jiusei0319@gmail.com ou ligue para +86 18633878701 para confirmar",
    "ar": "بعد الدفع ، يرجى إرسال لقطة الشاشة إلى jiusei0319@gmail.com أو الاتصال الهاتفي +86 18633878701 للتأكيد",
    "fr": "Après paiement, veuillez envoyer une capture d'écran à jiusei0319@gmail.com ou appelez le +86 18633878701 pour confirmer",
    "hi": "भुगतान के बाद कृपया स्क्रीनशॉट jiusei0319@gmail.com या +86 18633878701 पर भेजें और पुष्टि करें",
  },
  "5步开通自助展台": {
  ...
  "拍卖收费标准": {
    "en": "Auction Fee Schedule",
    "ru": "Тарифы на аукционные услуги",
    "es": "Tarifas de subasta",
    "pt": "Tabela de taxas de leilão",
    "ar": "جدول رسوم المزاد",
    "fr": "Barème des frais d'enchères",
    "hi": "नीलामी शुल्क दर",
  },
  "本通道拍卖业务由持牌拍卖机构依法开展，佣金由其按下列标准收取；平台不收取交易佣金、不接触交易资金。以上标准自取得《拍卖经营批准证书》并正式开拍之日起适用。": {
    "en": "Auction services on this channel are conducted by a licensed auction institution in accordance with the law, and commissions are collected by that institution at the rates below. The platform does not charge transaction commissions or handle transaction funds. These rates apply from the date the Auction Business Approval Certificate is obtained and the auction formally opens.",
    "ru": "Аукционные услуги на этом канале осуществляются лицензированным аукционным учреждением в соответствии с законом, и комиссию оно взимает по указанным ниже ставкам. Платформа не взимает комиссию за сделку и не имеет дела с денежными средствами сделки. Эти ставки применяются с даты получения «Свидетельства об утверждении аукционной деятельности» и официального открытия аукциона.",
    "es": "Los servicios de subasta de este canal son prestados por una institución de subastas autorizada conforme a la ley, y esta cobra las comisiones según las tarifas indicadas. La plataforma no cobra comisiones de transacción ni gestiona fondos de la operación. Estas tarifas se aplican desde la fecha en que se obtenga el «Certificado de aprobación de actividad de subastas» y la subasta se abra oficialmente.",
    "pt": "Os serviços de leilão neste canal são prestados por uma instituição de leilões licenciada, nos termos da lei, e as comissões são cobradas por ela conforme as taxas abaixo. A plataforma não cobra comissões de transação nem lida com fundos da operação. Estas taxas aplicam-se a partir da data de obtenção do «Certificado de Aprovação de Atividade de Leilões» e da abertura oficial do leilão.",
    "ar": "تُقدَّم خدمات المزاد في هذه القناة من قبل مؤسسة مزادات مرخّصة وفقًا للقانون، وتتولى هي تحصيل العمولة وفق المعدلات أدناه. ولا تتقاضى المنصة أي عمولة على الصفقة ولا تتعامل مع أموال الصفقة. تُطبَّق هذه المعدلات اعتبارًا من تاريخ الحصول على «شهادة الموافقة على مزاولة نشاط المزاد» والافتتاح الرسمي للمزاد.",
    "fr": "Les services d'enchères de ce canal sont assurés par une institution d'enchères agréée conformément à la loi, qui perçoit les commissions selon les tarifs ci-dessous. La plateforme ne perçoit aucune commission de transaction et ne gère pas les fonds de l'opération. Ces tarifs s'appliquent à compter de l'obtention du «Certificat d'approbation d'activité d'enchères» et de l'ouverture officielle des enchères.",
    "hi": "इस चैनल की नीलामी सेवाएँ विधि के अनुसार लाइसेंस प्राप्त नीलामी संस्थान द्वारा संचालित की जाती हैं, और आयोग उसी संस्थान द्वारा नीचे दी गई दरों पर लिया जाता है। प्लेटफ़ॉर्म कोई लेनदेन आयोग नहीं लेता और लेनदेन धन से संपर्क नहीं करता। ये दरें «नीलामी व्यवसाय अनुमोदन प्रमाणपत्र» प्राप्त होने और नीलामी के औपचारिक रूप से शुरू होने की तिथि से लागू होंगी।",
  },
  "买方佣金": {
    "en": "Buyer's premium",
    "ru": "Комиссия покупателя",
    "es": "Comisión del comprador",
    "pt": "Comissão do comprador",
    "ar": "عمولة المشتري",
    "fr": "Commission acheteur",
    "hi": "क्रेता आयोग",
  },
  "落槌价的 3%（由买受人承担）": {
    "en": "3% of the hammer price (borne by the buyer)",
    "ru": "3% от цены молотка (за счет покупателя)",
    "es": "3% del precio de adjudicación (a cargo del comprador)",
    "pt": "3% do preço de arrematação (a cargo do comprador)",
    "ar": "3% من سعر المطرقة (يتحمّلها المشتري)",
    "fr": "3% du prix d'adjudication (à la charge de l'acheteur)",
    "hi": "हैमर मूल्य का 3% (क्रेता द्वारा वहन)",
  },
  "卖方佣金": {
    "en": "Seller's commission",
    "ru": "Комиссия продавца",
    "es": "Comisión del vendedor",
    "pt": "Comissão do vendedor",
    "ar": "عمولة البائع",
    "fr": "Commission vendeur",
    "hi": "विक्रेता आयोग",
  },
  "落槌价的 2%（从成交款中扣除）": {
    "en": "2% of the hammer price (deducted from the proceeds)",
    "ru": "2% от цены молотка (удерживается из суммы сделки)",
    "es": "2% del precio de adjudicación (se deduce del importe de la operación)",
    "pt": "2% do preço de arrematação (deduzido do valor da operação)",
    "ar": "2% من سعر المطرقة (تُخصم من مبلغ الصفقة)",
    "fr": "2% du prix d'adjudication (déduits du montant de la transaction)",
    "hi": "हैमर मूल्य का 2% (लेनदेन राशि से काटा जाएगा)",
  },
  "费用示例：落槌价 ¥100,000 → 买受人实付 ¥103,000，委托人净得 ¥98,000。": {
    "en": "Example: hammer price ¥100,000 → the buyer pays ¥103,000, and the consignor receives ¥98,000 net.",
    "ru": "Пример: цена молотка ¥100 000 → покупатель платит ¥103 000, консигнатор получает на руки ¥98 000.",
    "es": "Ejemplo: precio de adjudicación ¥100.000 → el comprador paga ¥103.000 y el comitente recibe ¥98.000 netos.",
    "pt": "Exemplo: preço de arrematação ¥100.000 → o comprador paga ¥103.000 e o comitente recebe ¥98.000 líquidos.",
    "ar": "مثال: سعر المطرقة ¥100,000 → يدفع المشتري ¥103,000 ويحصل الموكل على ¥98,000 صافيًا.",
    "fr": "Exemple : prix d'adjudication 100 000 ¥ → l'acheteur paie 103 000 ¥ et le commettant reçoit 98 000 ¥ net.",
    "hi": "उदाहरण: हैमर मूल्य ¥100,000 → क्रेता ¥103,000 का भुगतान करता है और स्वामी को शुद्ध ¥98,000 मिलते हैं।",
  },
  "真实拍卖通道": {
  ...
  "📌 付款后请将截图发至 jiusei0319@gmail.com 或致电 +86 18633878701，24小时内开通自助展台。": {
    "en": "📌 After payment, send screenshot to jiusei0319@gmail.com or call +86 18633878701. Activated within 24 hours.",
    "ru": "📌 После оплаты, пожалуйста, отправьте скриншот на jiusei0319@gmail.com или позвоните по номеру +86 18633878701, в течение 24 часов будет открыт自ослуживаемый стенд.",
    "es": "📌 Después del pago, por favor envíe una captura de pantalla a jiusei0319@gmail.com o llame al +86 18633878701, se abrirá el stand de auto-servicio dentro de 24 horas.",
    "pt": "📌 Após o pagamento, por favor envie uma captura de tela para jiusei0319@gmail.com ou ligue para +86 18633878701, dentro de 24 horas para ativar o stand de autoatendimento.",
    "ar": "📌 بعد الدفع، يرجى إرسال صورة الشاشة إلى jiusei0319@gmail.com أو الاتصال بالهاتف +86 18633878701، سيتم تفعيل منصة العرض الذاتي في غضون 24 ساعة.",
    "fr": "📌 Après le paiement, veuillez envoyer une capture d'écran à jiusei0319@gmail.com ou appelez le +86 18633878701, le stand auto sera ouvert dans les 24 heures.",
    "hi": "📌 भुगतान करने के बाद कृपया स्क्रीनशॉट jiusei0319@gmail.com पर भेजें या +86 18633878701 पर कॉल करें, 24 घंटों के भीतर स्व-प्रदर्शनी खोली जाएगी।",
  },
  ...
  "提交后我们将在2个工作日内审核。如需加急，请联系 jiusei0319@gmail.com 或致电 +86 18633878701": {
    "en": "We will review within 2 business days. For urgent requests, contact jiusei0319@gmail.com or call +86 18633878701.",
    "ru": "После отправки ваша заявка будет рассмотрена в течение 2 рабочих дней. Для срочного рассмотрения свяжитесь с jiusei0319@gmail.com или позвоните по телефону +86 18633878701",
    "es": "Después de enviar, nosotros lo verificaremos dentro de 2 días hábiles. Si necesita urgencia, por favor contacte con jiusei0319@gmail.com o llame al +86 18633878701",
    "pt": "Após o envio, faremos a auditoria dentro de 2 dias úteis. Se precisar de urgência, por favor contate jiusei0319@gmail.com ou ligue para +86 18633878701",
    "ar": "بعد التقديم، سنقوم بالتحقق في غضون 2 يوم عمل. إذا كنت تحتاج إلى إجراء سريع، يرجى الاتصال jiusei0319@gmail.com أو الاتصال الهاتفي +86 18633878701",
    "fr": "Après soumission, nous allons procéder à la vérification dans les 2 jours ouvrables. Si vous avez besoin d'urgence, veuillez contacter jiusei0319@gmail.com ou appeler +86 18633878701",
    "hi": "जमा करने के बाद हम 2 कार्य दिवसों के भीतर सत्यापन करेंगे। यदि त्वरित आवश्यकता है, तो jiusei0319@gmail.com से संपर्क करें या +86 18633878701 पर कॉल करें",
  },
  "视频超过100MB限制": {

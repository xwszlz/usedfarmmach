      ...
      <div className="rounded-lg border-l-4 border-amber-500 bg-amber-50 px-4 py-3 text-sm text-amber-900">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-1.5">
            ...
            <p>
              • 真实拍卖入口仅在本站（.cn）显示；当前为合规占位页。
              平台注册地在元氏县（县级），依冀商规字〔2020〕2号<b>无法自取《拍卖经营批准证书》</b>，
              须与<b>合作持牌拍卖机构</b>联合开展，故对公众不可见、请勿宣传（合规红线）。
            </p>
            <p>
              • 落槌权归合作持牌机构：落槌接口须校验「主持拍卖师已登记于该场落槌的持牌机构，
              且该机构状态为合作中」，平台身份调用仅记为代录。机构资质失效即自动拒绝落槌。
            </p>
            <p>
              • 取证后填入环境变量 <code>CN_AUCTION_LICENSE_NO</code>，公示徽章（S4）自动上线、
              真实竞价（P2 六路由）即可启用，无需改代码。
            </p>
            <p>
              • 后台拍卖师挂靠录入：
              <Link
            ...
            {!isCn && (
              <p className="rounded bg-amber-100 px-2 py-1 text-amber-800">
                ⚠️ 你当前在 .com 国际站，拍卖功能为 .cn 专属。请切换到 .cn 站点查看「真实拍卖」入口。
              </p>
            )}
          </div>
          <button
            ...
            className="shrink-0 rounded-md border border-amber-300 px-2 py-1 text-xs text-amber-800 hover:bg-amber-100"
          >
            收起
          </button>
        </div>

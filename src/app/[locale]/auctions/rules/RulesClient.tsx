...
export default function RulesClient() {
  ...
  const guarantees = [
    ...
    },
    {
      icon: "⚖️",
      title: tr("法律保障"),
      desc: tr("附江苏金融租赁购买合同等现有权属文件。因标的物暂无农机登记证书，过户存在障碍，卖方不协助办理过户手续。买方应在交易前自行了解过户可行性并自担风险。"),
    },
    {
      icon: "🤝",
      title: tr("权责对等"),
  ...
  const risks = [
    ...
    tr("设备可能存在零部件缺失（如前配重、后悬挂等），详情页已公示。建议实地验机后再报价"),
  ...
  const faqs = [
    ...
    {
      q: tr("设备无法过户怎么办？"),
      a: tr("卖方如实披露标的物权属状况。本标的暂无农机登记证书，仅有江苏金融租赁购买合同，权属文件不完整。卖方不协助办理过户手续。买方应在报价前自行了解标的物能否在所在地办理过户登记及上牌使用，因无法过户或上牌导致的全部风险由买方自行承担。卖方不存在隐瞒或虚假陈述的，买方不得以权属文件不全为由要求解除合同或索赔。"),
    },
    {
      q: tr("如何确保设备质量？"),
      a: tr("卖方如实告知已知瑕疵（缺少前配重、后悬挂等），标的物按现状交付。卖方对经合理查验可发现的瑕疵不承担担保责任，但对明知或应知而未披露的重大瑕疵，以及因故意隐瞒或虚假陈述导致的损失，仍依法承担责任。买方在交付后发现隐蔽瑕疵的，应在约定期限内书面通知卖方。"),
    },
    {
      q: tr("需要交保证金吗？"),

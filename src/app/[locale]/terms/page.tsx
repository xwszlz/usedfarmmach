    ...
    <>
      ...
      <section>
        ...
        <ol className="list-decimal pl-6 space-y-2">
          <li>
            <strong>平台定位：</strong>
            神雕农机（usedfarmmach.cn及&ldquo;神雕农机&rdquo;微信小程序）是一个二手农机及相关设备的信息发布与撮合平台。
            我们提供信息展示、搜索、联系、AI估值辅助等服务，<strong>不参与实际交易，不作为买方或卖方当事人，不担保交易的完成。</strong>
          </li>
          <li>
            <strong>服务内容：</strong>
      ...
      <section>
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li>
            <strong>支付方式：</strong>
            会员费通过<strong>微信小程序收发通（微信支付）</strong>收取。资金由微信支付直接清算至本平台商户账户，
            <strong>平台不触碰、不中转用户资金</strong>；您亦可通过对公银行转账方式缴纳会员费，具体收款账户信息将在您选择会员升级时展示。
          </li>
          <li>
            <strong>退费政策：</strong>
            会员服务为数字内容服务，一经开通不支持无理由退款。
      ...
      <section>
        ...
        <ol className="list-decimal pl-6 space-y-2">
          ...
          <li>
            因本协议或本平台服务产生的争议，双方应首先通过友好协商解决。
            协商不成的，任何一方均可向<strong>被告住所地（河北省石家庄市）</strong>有管辖权的人民法院提起诉讼。
          </li>
          <li>
            在争议解决期间，不涉及争议的条款继续有效。
          </li>

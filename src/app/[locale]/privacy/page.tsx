...
function PrivacyContentCn() {
  return (
    <>
      <p className="text-gray-600 dark:text-gray-400">
        石家庄神雕农机科技有限公司（以下简称&ldquo;我们&rdquo;或&ldquo;神雕农机&rdquo;）运营
        usedfarmmach.cn 网站及&ldquo;神雕农机&rdquo;微信小程序（以下简称&ldquo;本平台&rdquo;）。
        我们深知个人信息对您的重要性，将严格按照《中华人民共和国个人信息保护法》
        （以下简称&ldquo;个保法&rdquo;）、《中华人民共和国数据安全法》、《中华人民共和国网络安全法》
        （以下合称&ldquo;三法&rdquo;）等法律法规，在中国境内收集、存储和处理您的个人信息，保护您的个人信息权益。
      </p>
        ...
        <table className="w-full text-sm border border-gray-200 dark:border-gray-700 mt-3">
          ...
          <tbody>
            ...
            <tr>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">微信小程序信息</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">微信OpenID、UnionID（经微信授权获取）</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">小程序用户身份识别与登录态维持</td>
            </tr>
            <tr>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">会员支付信息</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">会员等级、订单与充值记录（支付由微信支付/微信收付通处理，我们不存储完整支付凭证）</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">会员服务管理与订单对账</td>
            </tr>
            <tr>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">设备与技术信息</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">IP地址、浏览器类型、操作系统、设备标识符</td>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">四、信息共享与委托处理（境内）</h2>
        <p>
          我们不会向任何第三方<strong>出售</strong>您的个人信息。为实现本平台服务功能，我们会委托
          <strong>位于中国境内的</strong>受托方处理您的部分个人信息。我们与受托方签订严格的委托处理协议，
          约定处理目的、期限、方式及保护措施，并要求受托方返回或删除个人信息。委托处理情况如下：
        </p>
        <table className="w-full text-sm border border-gray-200 dark:border-gray-700 mt-3">
          <thead className="bg-gray-50 dark:bg-gray-800">
            <tr>
              <th className="border border-gray-200 dark:border-gray-700 px-3 py-2 text-left">境内受托方</th>
              <th className="border border-gray-200 dark:border-gray-700 px-3 py-2 text-left">处理信息</th>
              <th className="border border-gray-200 dark:border-gray-700 px-3 py-2 text-left">处理目的</th>
              <th className="border border-gray-200 dark:border-gray-700 px-3 py-2 text-left">所在地域</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">阿里云 ECS（云服务器）</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">用户注册信息、产品数据（本地 PostgreSQL 数据库）</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">用户与产品数据的存储及管理</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">中国河北省 / 北京</td>
            </tr>
            <tr>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">阿里云 OSS（对象存储）</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">用户上传的农机图片</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">图片存储与CDN加速</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">中国北京</td>
            </tr>
            <tr>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">微信支付 / 微信收付通</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">会员订单与支付流水（由微信侧处理）</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">会员订单收取与支付清算</td>
              <td className="border border-gray-200 dark:border-gray-700 px-3 py-2">中国（微信支付境内主体）</td>
            </tr>
          </tbody>
        </table>
        <p className="mt-2">
          除上述委托处理情形外，我们仅在以下情形共享您的个人信息：取得您的单独同意、为履行法定义务所必需、
          为保护您或他人的重大合法权益所必需等法定情形。我们不会向境外接收方提供您的个人信息。
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2">
          ...
          因此，本政策<strong>不涉及个人信息跨境传输</strong>章节，亦无需就个人信息出境取得您的单独同意。
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2">
          存储地点：全部用户个人信息与产品数据存储于中国境内（阿里云 ECS 本地 PostgreSQL，河北省 / 北京；图片存储于阿里云 OSS，北京）。
        </p>
      </section>

      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">七、您的个人信息主体权利</h2>
        <p>根据个保法第四十四条至第四十七条，您对您的个人信息享有以下权利：</p>
        <table className="w-full text-sm border border-gray-200 dark:border-gray-700 mt-3">
          <thead className="bg-gray-50 dark:bg-gray-800">
            <tr>
              <th className="border border-gray-200 dark:border-gray-700 px-3 py-2 text-left">权利类型</th>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">八、敏感个人信息特殊保护</h2>
        <p>
          我们在以下场景中可能处理您的敏感个人信息。根据个保法第二十八条至第三十二条，
          处理敏感个人信息需取得您的<strong>单独同意</strong>，并采取更严格的保护措施：
        </p>
        <ul className="list-disc pl-6 space-y-2 mt-2">
          <li>
          ...
          <li>
            <strong>支付信息：</strong>会员费通过微信支付 / 微信收付通收取，
            我们不接触、不存储您的完整支付凭证（银行卡号、支付密码等）。
          </li>
        </ul>
      </section>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">十二、自动化决策与算法推荐</h2>
        <p>
          本平台使用AI算法提供估值服务和内容推荐。根据个保法第二十四条，
          您有权要求我们对自动化决策的结果进行说明，并有权拒绝仅通过自动化决策方式做出的决定。
          如您希望行使该权利，请发送邮件至DPO邮箱。
        </p>
        <p className="mt-2">
      ...
      <div className="mt-8 rounded-lg bg-gray-50 dark:bg-gray-800 p-4 text-xs text-gray-500 dark:text-gray-400">
        <p>
          本隐私政策由石家庄神雕农机科技有限公司制定，依据《中华人民共和国个人信息保护法》
          《中华人民共和国数据安全法》《中华人民共和国网络安全法》等法律法规编制。
          本政策应与《用户协议》配合阅读。本平台所有个人信息与产品数据均存储于中国境内，
          不向任何境外接收方传输。本政策最终解释权归石家庄神雕农机科技有限公司所有。
        </p>
      </div>
    </>
  );
